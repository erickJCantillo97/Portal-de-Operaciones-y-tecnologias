...
const buttons = [
    { event: 'userDetalis', severity: 'info', class: '', icon: 'fa-solid fa-user-tag', text: true, outlined: false, rounded: false },
]
    ...
    <AppLayout>
        <div class="">
            <div class="px-4 space-y-2">
                ...
                <p class="text-md text-gray-700 italic w-1/2 text-justify">Un rol proporciona acceso a menús y funciones
                    predefinidos
                    para
                    que,
                    dependiendo del
                    rol asignado, un administrador pueda tener acceso de lo que cada usuario necesita.</p>
            </div>
            <div class="grid grid-cols-3 gap-8 m-4">
                <div class="shadow-lg rounded-lg p-4 bg-gray-50" v-for="rol in  roles ">
                    <div class="flex">
                        <div class="flex justify-between w-full">
                            <span class="text-sm text-gray-600">Total {{ rol.users.length }} Usuarios</span>
                            <span class="flex">
                    ...
                    <div class="text-gray-900 font-extrabold text-xl mt-4 flex justify-between">
                    ...
                    <p>{{ rol.permissions.length }}</p>
                </div>
                <div class="shadow-lg rounded-lg p-4 bg-gray-50 flex space-x-12">
                    <img src="/images/men.gif" alt="" class="h-24">
                    <span>
