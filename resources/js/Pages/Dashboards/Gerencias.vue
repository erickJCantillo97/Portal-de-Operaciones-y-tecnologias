    ...
    <AppLayout>
        <div class="mt-4 px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between">
                <h2 class="font-medium text-primary text-xl">Personal Corporativo {{GERENCIA}}</h2>
                <h2 class="font-medium text-primary text-xl">Total: {{totalMembers}} Personas</h2>
            </div>

            <div role="list" class="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-2 lg:grid-cols-5 h-32 sm:h-auto overflow-y-auto custom-scroll snap-y snap-proximity">
