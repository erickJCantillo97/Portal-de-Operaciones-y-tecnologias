...
<template>
  <div class="max-h-full h-56 mb-8">
    <div class="bg-blue-800 text-center  rounded-t-md sticky">
      <h3 class="text-white text-lg font-semibold p-1">Tiempo Promedio de Respuesta de Estimadores</h3>
    </div>
    <div class=" custom-scroll border rounded-lg">
      <CardSkeleton v-if="showCardSkeleton" />
      <div class="block space-y-4 max-h-full h-56 p-3 overflow-y-auto">
