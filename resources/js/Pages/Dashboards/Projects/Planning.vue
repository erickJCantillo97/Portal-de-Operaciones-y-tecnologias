    ...
    <div class="grid grid-cols-4 gap-2 mb-8">
      <div class="col-span-2 border border-gray-200 rounded-lg shadow-sm">
        ...
        <div class="flex justify-center size-full">
          <GaugeGradeChart :key="showLineChart" title="CPI" :value="1.028" />
          <GaugeGradeChart :key="showLineChart" title="SPI" :value="1.010" />
        </div>
      </div>
      <div class="col-span-2 border border-gray-200 rounded-lg shadow-sm">
        <div class="flex justify-center items-center p-1 rounded-t-lg bg-blue-800 text-white">
        ...
        <div class="flex justify-center size-full">
          <GaugeGradeChart :key="showLineChart" title="CPI" :value="1.026" />
          <GaugeGradeChart :key="showLineChart" title="SPI" :value="1.003" />
        </div>
      </div>
    </div>
