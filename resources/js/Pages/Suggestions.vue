...
<template>
    <div class="w-1/2">
        <div v-for="suggestion in suggestions" :class="suggestion.type == 'Error' ? 'border-danger' : 'border-primary'"
        ...
        <div class="grid grid-cols-10">
            <div class="flex items-center justify-center h-full">
                ...
                <svg class="fill-danger" v-if="suggestion.type == 'Error'" xmlns="http://www.w3.org/2000/svg" height="2em"
            ...
            <div class="flex flex-col justify-between col-span-9 pl-2">
                ...
                <div class="flex pt-1 mt-1 border-t border-gray-300 ">
                    <span v-if="suggestion.type == 'Error'" class="flex justify-center px-2 text-xs font-medium rounded-md"
