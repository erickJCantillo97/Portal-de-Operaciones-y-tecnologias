...
<template>
    ...
    <div class="flex min-h-full flex-1">
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    ...
                    <h2 class="mt-8 text-2xl font-bold leading-9 tracking-tight text-gray-900">Binevenido al Portal de <br>
                        Operaciones Tecnologicas</h2>
                ...
                <div class="mt-10">
                    <div>
                        <form action="#" method="POST" @submit.prevent="submit" class="space-y-6">
                            <div>
                                <label for="price" class="block text-sm font-medium leading-6 text-gray-900">Nombre de
                                    Usuario</label>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <label for="remember-me"
                                        class="ml-3 block text-sm leading-6 text-gray-700">Recuérdame</label>
                                </div>
                            ...
                            <div>
                                <Button severity="primary" :loading="form.processing">Iniciar Sesión</Button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="relative hidden w-0 flex-1 lg:block min-h-full">
