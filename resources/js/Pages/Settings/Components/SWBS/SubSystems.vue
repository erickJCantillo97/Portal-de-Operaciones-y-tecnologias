                    ...
                    <div title="Editar Sistema"
                        ...
                        <div title="Eliminar Sistema">
                            <Button severity="danger"
                                @click="confirmDelete(slotProps.data.id, 'SubSistema', 'subsystem')"
                            ...
                            <div>
                                <div class="px-2 mt-2 text-center">
                                    <DialogTitle as="h3" class="text-xl font-semibold text-primary ">
                                        {{ formData.id != 0 ? 'Editar ' : 'Crear' }} SubSistema
                                    ...
                                    <div class="p-2 mt-2 space-y-4 border border-gray-200 rounded-lg">
                                        <div class="col-span-1 py-2 md:col-span-4 p-fluid p-input-filled">
                                            ...
                                            <TextInput class="mt-2 text-left" type="string"
                                                label="Nombre del SubSistema" :placeholder="'Nombre del subsistema'"
