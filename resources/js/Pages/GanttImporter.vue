...
onMounted(() => {
    const
        ...
        projectLoaderScript = '/modImport/php/load.php',
        gantt = new Gantt({
            appendTo: 'contenedorGantt',
            emptyText: 'Arrastre y suelte un archivo Ms Project',
            ...
            async importFile(file) {
                ...
                gantt.maskBody('Importando, espere por favor ...');
                ...
                try {
                    ...
                    console.log(error);
                    onError(`Error al importar: ${error.error?.message || 'Error al importar'}`);
                }
            }
        });
