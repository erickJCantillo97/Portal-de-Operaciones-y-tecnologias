...
<template>
    <AppLayout>
        <CustomDataTable :data="quotes" :columnas="columnas">
            <template #header>
                ...
                <Button title="Agregar Estimación" @click="openQuoteSlideOver()" severity="success" label="Ver" outlined
                    icon="fa-solid fa-plus" class="!h-8" />
            </template>
        </CustomDataTable>
        <!--MODAL DE FORMULARIO-->
    ...
    <QuoteSlideOverDetails :openDialog="openModal" @closeModal="openModal = false"/>
</template>
