...
<template>
  <div class="flow-root">
    <ul role="list" class="h-64 overflow-y-auto p-6">
          ...
          <div class="relative flex items-start space-x-3">
            <template v-if="activityItem.type === 'comment'">
              ...
              <div class="min-w-0 flex-1">
                <div>
                  <div class="text-sm">
                    <a :href="activityItem.person.href" class="font-medium text-gray-900">{{ activityItem.person.name
                    }}</a>
                  </div>
            ...
            <template v-else-if="activityItem.type === 'assignment'">
              ...
              <div class="min-w-0 flex-1 py-1.5">
                <div class="text-sm text-gray-500">
                  ...
                  assigned
                  {{ ' ' }}
                  <a :href="activityItem.assigned.href" class="font-medium text-gray-900">{{ activityItem.assigned.name
                  }}</a>
                  {{ ' ' }}
    ...
    <CommentForm class="bottom-0 left-0 right-0 p-6 mt-4" />
  </div>
</template>
