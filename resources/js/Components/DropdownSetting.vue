<template>
    <div class="max-w-sm">
      <Popover v-slot="{ open }" class="relative">
        ...
        >
          <PopoverPanel
            class="absolute -left-36 z-10 mt-3 w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl"
          >
            <div
              class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5"
            >
              <div class="relative grid gap-8 bg-white p-7 lg:grid-cols-2">
                <Link href="/" class="-m-3 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-gray-200 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                >
                  ...
                  <div class="ml-4">
                    ...
                    <p class="text-sm text-gray-500">
                        Agregue o edite variables basicas del sistemas
                    </p>
                  </div>
                </Link>
              </div>
