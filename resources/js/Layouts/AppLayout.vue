            ...
            'group flex w-full items-center rounded-md px-2 py-2 text-sm',]">
             ...
             -->
                ...
                <div class="fixed right-[-5px] z-50 w-10 top-1/4 animate-pulse" data-html2canvas-ignore>
                    <button v-tooltip="'¿Alguna sugerencia?'" @click="sugerenciaVisible = true"
                        v-if="!sugerenciaVisible"
                                                            ...
                                                            <div class="grid grid-cols-10">
                                                                <div class="flex items-center justify-center h-full">
                                                                    <svg class="fill-yellow-400"
                                                                        v-if="suggestion.type == 'Sugerencia'"
                                                                ...
                                                                <div
                                                                    class="flex flex-col justify-between col-span-9 pl-2">
                                                                    <p class="text-xs font-bold">{{ suggestion.details
                                                                        }}
                                                                    </p>
                                                                    <div
                                                                        class="flex pt-1 mt-1 border-t border-gray-300 ">
