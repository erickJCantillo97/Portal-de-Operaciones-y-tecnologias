...
<main class="h-screen min-h-screen w-full max-w-full bg-white">
    <section class="flex h-screen p-12">
        <article class="w-full items-center justify-center align-middle">
            ...
            <article class="mt-20 p-6">
                <p class="font-semibold leading-8 text-indigo-600 underline">ERROR 403</p>
                <h1 class="mt-4 text-balance text-3xl font-bold leading-loose text-gray-900 sm:text-5xl">
                    La página a la que intenta acceder está restringida
                </h1>
                <p class="mt-6 text-gray-600">
                    Por favor contacte con el administrador de la plataforma.
                </p>
                <div class="mt-6">
                    <button type="button" class="rounded-lg border border-blue-700 p-1 hover:bg-blue-400 hover:text-white"
                        @click="logout()">
                        <a class="text-sm font-semibold text-blue-800">
        ...
        <div class="flex jutify-center items-center">
            @include('errors.partials.403_SVG')
        </div>
    </section>
